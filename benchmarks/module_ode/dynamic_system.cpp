...
// TODO: Rewrite this outdated mess from the scratch
...
// constexpr gse::Extent N = 6;
// constexpr Scalar T = 5;
// constexpr Scalar time_step = 1e-5;
...
//     const Vector y0 = gse::init::random<Scalar>(N);
...
//     const Scalar callback_frequency = T / 2;

//     integrator.time_step = tau;
